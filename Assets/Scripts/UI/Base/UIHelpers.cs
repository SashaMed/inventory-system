...
public static class UIHelpers
{
    ...
    public static void VerticalScrollTo(this Transform target, Vector3? offsetTarget = null, Vector2? trueOffset = null)
    {
        Canvas.ForceUpdateCanvases();
        ...
        {
            var contentPanel = scrollRect.content;
            var pld = contentPanel.anchoredPosition;
            ...
            contentPanel.anchoredPosition = newPos + trueOffset ?? Vector2.zero;

            Debug.Log($"VerticalScrollTo old {pld} new {contentPanel.anchoredPosition}");
        }
    }
